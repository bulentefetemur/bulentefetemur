...
* **Key Tech:** Python, Flask, OpenAI API (Context Management), JavaScript.
* **Features:** Remembers previous messages (Memory), custom "Movie Guru" persona, real-time "typing..." indicator, and bilingual UI (TR/EN).
* **Source Code:** [View on GitHub](https://github.com/bulentefetemur/AI-CHATBOT)

### 🎨 2. AI Color Palette Generator
A creative tool that generates color schemes based on text prompts using structured AI data.
* **Key Tech:** Python, Flask, OpenAI JSON Mode.
* **Features:** Forces AI to return strict JSON data to dynamically render color swatches on the frontend.
* **Source Code:** [View on GitHub](https://github.com/bulentefetemur/AI-PALETTE-GENERATOR)

### 📝 3. AI Text Summarizer
A productivity tool that condenses long articles into 2-3 sentence summaries.
* **Key Tech:** Python, Flask, HTML/CSS.
* **Features:** Handles HTTP POST requests, processes text input, and displays AI-generated summaries instantly.
* **Source Code:** [View on GitHub](https://github.com/bulentefetemur/AI-SUMMARIZER)
...
* **Features:** 24-hour daily grid, sticky "Excel-style" headers, precise minute-based task timing, and an integrated **Gemini AI assistant** to break down large tasks.
* **Tech Stack:** HTML, Tailwind CSS, JavaScript (ES6+), Google Gemini API.
* **Live App:** [Click to View](https://bulentefetemur.github.io/iCalender/)
* **Source Code:** [View on GitHub](https://github.com/bulentefetemur/iCalender)
...
* **Teknolojiler:** Python, Flask, OpenAI API (Context Yönetimi), JavaScript.
* **Özellikler:** Konuşma geçmişini hatırlar, özel "Film Gurusu" kişiliği, "yazıyor..." efekti ve Türkçe/İngilizce dil desteği.
* **Kaynak Kodu:** [GitHub'da İncele](https://github.com/bulentefetemur/AI-CHATBOT)

### 🎨 2. AI Renk Paleti Oluşturucu
Yazılı komutlardan yola çıkarak uyumlu renk paletleri üreten yaratıcı bir araç.
* **Teknolojiler:** Python, Flask, OpenAI JSON Modu.
* **Özellikler:** Yapay zekadan JSON formatında yapılandırılmış veri alarak arayüzde dinamik renk kutuları oluşturur.
* **Kaynak Kodu:** [GitHub'da İncele](https://github.com/bulentefetemur/AI-PALETTE-GENERATOR)

### 📝 3. AI Metin Özetleyici
Uzun makaleleri ve metinleri 2-3 cümleye indiren bir üretkenlik aracı.
* **Teknolojiler:** Python, Flask, HTML/CSS.
* **Özellikler:** HTTP POST isteklerini yönetir ve metin işleme algoritmalarıyla anlık özetler sunar.
* **Kaynak Kodu:** [GitHub'da İncele](https://github.com/bulentefetemur/AI-SUMMARIZER)
...
* **Özellikler:** 24 saatlik günlük takvim, "Excel stili" sabitlenmiş başlıklar, dakika bazlı görev zamanlaması ve büyük görevleri bölen **Gemini AI** asistanı.
* **Teknolojiler:** HTML, Tailwind CSS, JavaScript (ES6+), Google Gemini API.
* **Canlı Uygulama:** [Uygulamayı Görüntüle](https://bulentefetemur.github.io/iCalender/)
* **Kaynak Kodu:** [GitHub'da İncele](https://github.com/bulentefetemur/iCalender)
